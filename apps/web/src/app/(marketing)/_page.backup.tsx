// NOTE: This file conflicts with app/page.tsx (both resolve to `/`).
// Delete this file: rm "src/app/(marketing)/page.tsx"
// The home page is in app/page.tsx which imports the marketing layout components directly.
    ...
    <div className="flex flex-col">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          <Badge
            variant="secondary"
            className="mb-6 text-xs font-medium bg-white/5 border-white/10 text-muted-foreground"
          >
            ...
            {[
              {
                ...
                desc: "SOC 2 Type II certified. Data encrypted at rest and in transit.",
              },
              {
                icon: Globe,
                title: "Globally distributed",
                desc: "Edge-deployed across 50+ regions for sub-50ms latency worldwide.",
              },
              {
                icon: Zap,
                title: "Built to scale",
                desc: "From 5 to 50,000 users — the platform grows with your business.",
              },
            ].map((item) => {
